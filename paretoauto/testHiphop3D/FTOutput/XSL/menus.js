                ...
                <TD CLASS="clsMenuBarItem" id="tdMenuBarItemWarnings">
                  <xsl:element name="a">
                    <xsl:attribute name="href">
                     javascript:
                      warningsTransform('FaultTrees');
                      menuTransform('FaultTrees','Analysis Warnings');
                    </xsl:attribute>
                    Warnings
                  </xsl:element>
                </TD>
              ...
              <xsl:if test="(/HiP-HOPS_Results/FaultTrees/FMEA)">
                ...
                <TD CLASS="clsMenuBarItem" ID="tdMenuBarItemFMEA">
                  <xsl:element name="a">
                    <xsl:attribute name="href">
                      javascript:
                      fmeaTransform('<xsl:value-of select="$XmlFileName" />', 'DirectEffects', '0', '100');
                      menuTransform('<xsl:value-of select="$XmlFileName" />','Failure Modes and Effects Analysis');
                    </xsl:attribute>
