var cutSetsXSL = `<?xml version="1.0"?>
        ...
        <li>
          <xsl:element name="a">
            <xsl:attribute name="href">
              ...
              faultTreesTransform('<xsl:value-of select="$XmlFileName" />','<xsl:value-of select="$ftName" />');
              menuTransform('<xsl:value-of select="$XmlFileName" />','Fault Tree View: <xsl:value-of select="$ftName" />');
            </xsl:attribute>
            Fault Tree
          </xsl:element>
        </li>
